...
[Privacy Policy](https://lutartur.github.io/AlterCard/privacy-policy.html)
...
- **Редактирование карты** — переименование, изменение номера, смена цвета, удаление — прямо из экрана просмотра
...
- **Яркость экрана** — автоматическое повышение яркости до 85% при просмотре карты с восстановлением системной яркости при выходе
- **Тёмная тема** — поддержка системной тёмной темы (Material Design 3 DayNight)
- **Edge-to-edge** — полноэкранный интерфейс с адаптацией под системные вырезы и навигацию
...
- **Android SDK** с установленными API 30–36
